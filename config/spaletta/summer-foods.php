...
return [
    ...
    [
        'category_id' => 2,
        'name' => [
            'hu' => 'Spaletta kosár (BBQ csirkeszárny, süllő pofa pankó morzsában, rántott marhapofa, Remoulade-mártás,   lilahagymás majonéz, csípős)',
            'en' => 'Spaletta basket (BBQ chicken wing, zander cheek in panko breadcrumbs, breaded beef cheek, Remoulade sauce, red onion mayonnaise, spicy)',
            'de' => 'Spaletta-Korb (BBQ Hühnerflügel, Zandermaul im Pankó-Mantel, Gebackene Rindermaul, 
    ...
    [
        'category_id' => 2,
        'name' => [
            'hu' => 'Óriás bécsi szelet sertés (natúr, dijoni, zöldfűszeres) (L), házi hasábburgonya',
            'en' => 'Giant Wiener Schnitzel of pork (plain, Dijon style, herbed) (L), homemade French fries',
    ...
    [
        'category_id' => 2,
        'name' => [
            'hu' => 'Óriás bécsi szelet borjú húsból (natúr, dijoni, zöldfűszeres), bajor burgonya saláta',
            'en' => 'Giant Wiener Schnitzel of veal (plain, Dijon style, herbed), bavarian potato salad',
    ...
    [
        'category_id' => 33,
        'name' => [
            'hu' => 'Házi vegyes vágott',
            'en' => 'Homemade mixed cut pickles',
            'de' => 'Puszta-Salat'
        ],
        'comment' => '',
        'price' => 700,
