        ...
        <div class="">
            <div class="overflow-hidden bg-white shadow">
                <div class="px-4 pb-5 sm:p-6">
                    ...
                    <p class="mb-10 text-3xl"><span class="text-gold">72</span> órán belül küldjük a díjbekérőt. Ennek teljesítese után a regisztrált email címre(<span class="text-gold">{{ $ticket->email }}</span>) küldjük ki a jegyeket.</p>
