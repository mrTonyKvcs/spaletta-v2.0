...
<x-layout>
    ...
    <x-section background="christmas-section">
        <div class="flex justify-center">
            <div class="flex flex-col items-center justify-center mt-10 space-y-8 md:mt-0">
                <p class="text-3xl font-medium text-center text-gray2e font-libre">Anyák napja alkalmából ünnepeljük
                    együtt az Édesanyákat, vasárnap 11.30-16.00-ig szeretettel várjuk Vendégeinket a Spaletta
                    Étteremben!</p>
