<div class="flex flex-col justify-between px-4 py-5 border-t border-gray-200 md:flex-row sm:p-0 md:mr-5">
        ...
        <div class="flex flex-row items-center py-4 sm:py-5 sm:px-6">
            ...
            <div class="flex mt-4 sm:mt-0 sm:pr-9">
                <div>
                    ...
                    <select id="location" wire:model="quantity" class="block w-full py-2 pr-10 mt-1 text-2xl border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 rounded-md">
                        @for ($i=1; $i <= 10; $i++)
    ...
    <div x-data="{price: @entangle('price'), quantity: @entangle('quantity')}" class="flex flex-row items-center mt-3 md:mt-0">
