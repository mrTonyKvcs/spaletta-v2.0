<div class="h-screen flex overflow-hidden bg-gray-100" x-data="{ sidebarOpen: false }" @keydown.window.escape="sidebarOpen = false">
    <div x-show="sidebarOpen" class="lg:hidden" x-description="Off-canvas menu for mobile, show/hide based on off-canvas menu state." style="display: none;">
        ...
        <div x-show="sidebarOpen" x-description="Off-canvas menu, show/hide based on off-canvas menu state." x-transition:enter="transition ease-in-out duration-300 transform" x-transition:enter-start="-translate-x-full" x-transition:enter-end="translate-x-0" x-transition:leave="transition ease-in-out duration-300 transform" x-transition:leave-start="translate-x-0" x-transition:leave-end="-translate-x-full" class="relative flex-1 flex flex-col max-w-xs w-full pt-5 pb-4 bg-cyan-700" style="display: none;">
            ...
            <div class="px-2 space-y-1">
                    ...
                    <a href="#" class="bg-cyan-800  group flex items-center px-2 py-2 text-base font-medium rounded-md" aria-current="page">
    ...
    <div class="hidden lg:flex lg:flex-shrink-0">
      <div class="flex flex-col w-64">
        ...
        <div class="flex flex-col flex-grow bg-cyan-700 pt-5 pb-4 overflow-y-auto bg-gray48 text-white">
          <div class="flex items-center justify-center flex-shrink-0 px-4">
            <img class="w-14 md:w-20 lg:w-24" src="../images/logo/logo.png" alt="Spaletta-logo">
          </div>
          <nav class="mt-16 flex-1 flex flex-col divide-y divide-cyan-800 overflow-y-auto" aria-label="Sidebar">
            <div class="px-4 space-y-1">
              
                
                  <!-- Current: "bg-cyan-800 text-white", Default: "text-cyan-100 hover:text-white hover:bg-cyan-600" -->
                  <a href="#" class="group flex items-center px-2 py-2 text-2xl leading-6 font-medium rounded-md text-cyan-100 hover:text-gold hover:bg-cyan-600" aria-current="page">
                    <svg class="mr-4 h-6 w-6 text-cyan-200" x-description="Heroicon name: outline/home" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path>
                    </svg>
                    Home
                  ...
                  <a href="#" class="group flex items-center px-2 py-2 text-2xl leading-6 font-medium rounded-md text-cyan-100 hover:text-gold hover:bg-cyan-600">
                    <svg class="mr-4 h-6 w-6 text-cyan-200" x-description="Heroicon name: outline/clock" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                    </svg>
                    History
