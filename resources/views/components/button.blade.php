...
<button @if ($submit) type="submit"  @endif {{ $attributes->merge(['class' => "{$colors[$type]} inline-flex font-medium items-center pt-3.5 px-10 pb-2.5 text-2xl uppercase shadow-sm focus:outline-none"]) }}>
    {{ $slot }}
</button>
