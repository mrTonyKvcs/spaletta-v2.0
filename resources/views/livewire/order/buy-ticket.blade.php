<div>
            ...
            <div class="px-4 py-5">
                <div class="py-4 mt-1 text-2xl sm:py-5 sm:px-6">
                    ...
                    <a href="http://simplepartner.hu/PaymentService/Fizetesi_tajekoztato.pdf" target="_blank"
                        class="text-center">
                        <img width="70%" height="auto" src="/images/simplepay.png"
                ...
                <div class="flex items-start py-4 mt-1 sm:py-5 sm:px-6">
                    <div class="flex items-center mt-1 h-7">
                        <input id="comments" wire:model="invoiceData.gdpr" name="gdpr" type="checkbox"
                    ...
                    <div>
                        <div class="ml-3 text-2xl">
                            ...
                            <p class="text-gray-500">A "Jegyvásárlás" gomb megnyomásával Ön elfogadja az <a
                                    href="/pdfs/aszf.pdf" class="text-gold" target="_blank">Általános Szerződési
                                    Feltételeket, az Adatkezelési Szabályzatot</a>, a 45/2014. (II. 26) Korm. rendelet
                                15. §-a szerinti tájékoztatást, <a href="/pdfs/adattovabbitasi-nyilatkozat.pdf"
                                    class="text-gold" target="_blank">Adattovábbítási nyilatkozatot</a> valamint
                                kijelenti, hogy elmúlt 18 éves. </p>
                        </div>
                        @error('invoiceData.gdpr')
    ...
    <div class="py-3 mt-8 text-right ">
        <button wire:click="submit" wire:loading.class="hidden" type="submit"
            class="inline-flex justify-center px-4 py-2 text-2xl font-medium text-white uppercase border border-transparent rounded-md shadow-sm bg-gold hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
            Jegyvásárlás
        </button>
