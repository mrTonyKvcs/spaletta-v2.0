<div>
    <div class="lg:flex lg:items-center lg:justify-between">
        <div class="flex-1 min-w-0">
            <h2 class="text-2xl font-bold text-gray-900 leading-7 sm:text-3xl sm:truncate">
                Back End Developer
            </h2>
        ...
        <div class="flex mt-5 lg:mt-0 lg:ml-4">
            ...
            <span class="relative ml-3 sm:hidden">
                ...
                -->
                <div class="absolute right-0 w-48 py-1 mt-2 -mr-1 bg-white shadow-lg origin-top-right rounded-md ring-1 ring-black ring-opacity-5" aria-labelledby="mobile-menu" role="menu">
