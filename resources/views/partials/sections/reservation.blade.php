<div class="w-full lg:w-2/3 lg:grid lg:grid-cols-2 lg:gap-6">
    ...
    <div class="mb-6">
        <p class="text-center text-2xl gray font-medium">Időpont</p>
    ...
    <div class="mb-6">
        <p class="text-center text-2xl gray font-medium">Telefonszám</p>
        <input type="tel" class="w-full gray outline-none text-center font-medium py-2.5 px-5 text-xl border-b border-gray-300">
    </div>
    <div>
        <p class="text-center text-2xl gray font-medium ">Vendégek</p>
...
<a href=""><h3 class="uppercase text-white text-2xl font-medium rounded-full mt-10 px-10 pt-3 pb-2.5 gray-bg lg:hover:bg-gray-900">asztalfoglalás</h3></a>