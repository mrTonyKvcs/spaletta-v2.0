...
class SzamlaAgentAPI extends SzamlaAgent {
     ...
     */
    public static function create($apiKey, $downloadPdf = true, $logLevel = \SzamlaAgent\Log::LOG_LEVEL_DEBUG, $responseType = SzamlaAgentResponse::RESULT_AS_TEXT, $aggregator = '') {
